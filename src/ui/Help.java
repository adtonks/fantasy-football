...
public class Help extends JPanel {
	...
	public void create() {
		...
		String t = "WHAT IS THIS ABOUT?\n\n"
				...
				+ "STEP 2:\n"
				+ "Wait for your friends to join! When a maximum of 10 people have joined your game, start drafting!"
				+ "You can draft on your own, but it's always more fun to do it together!\n\n"
				+ "STEP 3:\n"
				+ "During the draft, choose 17 players of any position and football club.\n\n"
				+ "STEP 4:\n"
